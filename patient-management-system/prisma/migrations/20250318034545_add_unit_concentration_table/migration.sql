...
-- CreateEnum
CREATE TYPE "PatientHistoryType" AS ENUM ('MEDICAL', 'SURGICAL', 'FAMILY', 'SOCIAL', 'ALLERGY');

-- CreateEnum
CREATE TYPE "VitalType" AS ENUM ('NUMBER', 'TEXT', 'DATE');

-- CreateEnum
CREATE TYPE "ChargeType" AS ENUM ('DOCTOR', 'DISPENSARY');
...
CREATE TABLE "Prescription" (
    ...
    "extraDoctorCharge" DOUBLE PRECISION,
    "details" TEXT,
    "patientId" INTEGER NOT NULL,
...
CREATE TABLE "Bill" (
    "id" SERIAL NOT NULL,
    "doctorCharge" DOUBLE PRECISION NOT NULL,
    "dispensaryCharge" DOUBLE PRECISION NOT NULL,
    "medicinesCharge" DOUBLE PRECISION NOT NULL,
    "prescriptionId" INTEGER NOT NULL,
